...
@bot.on_poll_answer()
async def poll_answer_handler(_, answer):
...
async def report_card(_, m: Message):
...
async def daily_quiz(_, m: Message):
...
async def daily_quiz_start(_, cb):
...
async def all_subjects(_, m: Message):
...
async def create_study_plan(_, m: Message):
...
async def study_progress(_, m: Message):
...
async def generate_notes(_, m: Message):
...
async def formula_generator(_, m: Message):
...
async def pyq_generator(_, m: Message):
...
async def answer_daily(_, m: Message):
...
# =========================================================
# SUBJECT RECOMMENDER AI
# =========================================================

@bot.on_message(
    filters.command(["recommend"])
)
async def recommend_subject(_, m: Message):
    ...
    try:
        ...
        text = "📚 Subjects needing improvement:\n\n"
...
# =========================================================
# AI SUBJECT BUTTON MENU
# =========================================================

@bot.on_message(
    filters.command(["subjects"])
)
async def subjects_menu(_, m: Message):
...
async def subject_selected(_, cb: CallbackQuery):
...
async def start_ai_quiz(_, cb: CallbackQuery):
...
async def send_ai_question(chat_id, user_id):
...
async def ai_answer_checker(_, cb: CallbackQuery):
...
async def ask_ai_teacher(_, m: Message):
...
async def ai_doubt_solver(_, m: Message):
...
async def user_profile(_, m: Message):
...
async def analytics(_, m: Message):
...
async def achievements(_, m: Message):
    ...
    try:
        ...
        if tc >= 500:
            badges.append("🧠 Brain Master")

        if xp >= 5000:
            badges.append("🔥 Supreme Legend")
...
async def compare_performance(_, m: Message):
...
# =========================================================
# AUTO SAVE REPORT WHEN QUIZ ENDS
# =========================================================
...
async def quiz_hub(_, m: Message):
...
async def quiz_hub_callbacks(_, cb: CallbackQuery):

    data = cb.data

    if data == "hub_subjects":

        return await subjects_menu(
            _,
            cb.message
        )
...
async def poll_quiz(_, m: Message):
...
async def rapid_fire(_, m: Message):
...
async def rapid_question(chat_id, user_id):
...
async def rapid_answer(_, cb: CallbackQuery):
...
async def voice_quiz(_, m: Message):
...
async def motivate(_, m: Message):
...
async def group_rank(_, m: Message):
...
async def battle_mode(_, m: Message):
...
async def export_reports(_, m: Message):
